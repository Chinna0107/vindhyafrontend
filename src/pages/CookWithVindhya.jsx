...
const bulkItems = [
  ...
  { name: 'జంతికాలు', price: '₹240', quantity: '500g' },
  ...
  { name: 'చక్కోడీలు', price: '₹280', quantity: '500g' },
  { name: 'సన్నకరపూస', price: '₹260', quantity: '500g' },
  { name: 'కార్జికాయలు', price: '₹350', quantity: '500g' },
  { name: 'పల్లీ లడ్డు', price: '₹300', quantity: '500g' },
  { name: 'అత్రసాలు/గసాలు', price: '₹400', quantity: '500g' },
